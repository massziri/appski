                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      child: Text(place.category, style: const TextStyle(color: AppColors.darkNavy, fontSize: 10, fontWeight: FontWeight.bold)),
                    ),
                    const SizedBox(height: 8),
                    Text(place.getName(lang), style: const TextStyle(color: AppColors.white, fontSize: 18, fontWeight: FontWeight.bold)),
                    const SizedBox(height: 4),
                    Row(children: [
                      const Icon(Icons.location_on, size: 14, color: AppColors.gold),
                      const SizedBox(width: 4),
                      Text(place.region, style: const TextStyle(color: AppColors.lightGrey, fontSize: 12)),
                    ]),
                  ],
                ),
              ),
