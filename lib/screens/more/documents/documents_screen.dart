              ...
              const Expanded(
                child: Center(
                  child: Column(
                    ...
                    children: [
                      Icon(Icons.description, color: Colors.white70, size: 80),
                      SizedBox(height: 16),
                      Text('Documents', style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold)),
                      SizedBox(height: 8),
                      Text('Community documents will appear here', style: TextStyle(color: Colors.white70, fontSize: 14)),
                    ],
                  ),
                ),
              ),
